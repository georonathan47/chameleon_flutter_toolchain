...
/// `chameleon flutter create <name>` — scaffolds a new Chameleon Flutter app
/// by running `very_good create` (or plain `flutter create`), overlaying the
...
class FlutterCreateCommand extends Command<int> with PipelineSteps {
  ...
  Future<int> run() async {
    ...
    if (results.rest.isEmpty) {
      logger.err('Usage: chameleon flutter create <project_name>');
      ...
      await step('Initialising git', () async {
        ...
        return exec(
          ...
          [
            'commit',
            '-m',
            'Initial commit — generated by chameleon flutter create',
          ],
          cwd: outputDir.path,
        );
      });
