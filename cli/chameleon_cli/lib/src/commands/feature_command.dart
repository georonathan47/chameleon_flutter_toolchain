...
class FeatureCommand extends Command<int> with PipelineSteps {
  ...
  Future<int> run() async {
    ...
    if (results.rest.isEmpty) {
      logger.err('Usage: chameleon feature <feature_name>');
    ...
    if (!provenance.existsSync()) {
      logger.err(
        ...
        'Run `chameleon feature` from the root of a Chameleon app '
        'generated by `chameleon create`.',
      );
      return ExitCode.usage.code;
    }
    ...
    // if the project was renamed after `chameleon create`.
