<!-- Bug fix or new feature? Two more specific templates exist — add
     ?template=bug_fix.md or ?template=feature.md&expand=1 to this PR's
     compare URL (e.g. .../compare/main...your-branch?template=bug_fix.md)
     before creating it. This file is the general-purpose default, used
...
- [ ] If `bricks/chameleon_app`/`chameleon_feature`/`chameleon_bloc` changed: re-ran `mason bundle` for the affected brick(s) into `cli/chameleon_cli/lib/src/bundles/`, and the bundle diff is included in this PR
